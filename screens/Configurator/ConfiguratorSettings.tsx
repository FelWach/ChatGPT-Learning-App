...
import { creativityAtom, languageAtom, languageStyleAtom, questionAtom, dropdownMenuLanguageAtom, dropdownMenuLanguageStyleAtom, dropdownMenuQuestionAtom, difficultyAtom, dropdownMenuDifficultyAtom } from "./atoms";
...
export function ConfiguratorSettings() {
  ...
  const setAccurateness = useSetAtom(creativityAtom);
