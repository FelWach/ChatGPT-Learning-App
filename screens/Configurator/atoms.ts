...
export const creativityAtom = atom<number>(50);
...
export const dropdownMenuDifficultyAtom = atom<DropdownMenuItem[]>((get) => [
        { value: 'easy', name: 'Easy', id: 'easy' },
        { value: 'normal', name: 'Normal', id: 'normal' },
        { value: 'hard', name: 'Hard', id: 'hard' },
])
